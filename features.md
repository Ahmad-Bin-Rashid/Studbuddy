...
- **Semester Card**: Each semester will be represented by card which will have the following components: 
  ...
  - Each card will have 3 dots icon and by clicking that icon we will have 3 options: Set it as Active Semester (which will set it as Active) Edit Semester (by which we can edit semester name, starting date and ending date) and Delete Semester (which will only work if it contains no course in it otherwise it will show message to first delete its courses)
### Step 3:
- **Cards Sorting**: Add 3 dots icon on top right header of semester page. By clicking that it should open a menu having option of Sort in it. On clicking sort it should open two radio group options menu
...
- **Course Card**: Each Course card which will have the following components (alter course model if needed): 
  ...
  - Random light shade of color so that they look distinguishable. 
### Step 2:
- **Cards Sorting**: Add 3 dots icon on top right header of the page. By clicking that it should open a menu having option of Sort in it. On clicking sort it should open two radio group options menu
...
- **Course Assignments Page**: Use previously implemented assignment page functionality.
  ...
  - Each assignment card will have 3 dots icon to open edit menu by which we can edit or delete that assignment (use previously implemented menu).
  - Use 3 dots icon on top right header of the page to add assignments,
...
- **Course Exams Page**: Use previously implemented Exam page functionality.
  ...
  - Each Exam card will have 3 dots icon to open edit menu by which we can edit or delete that Exam (use previously implemented menu).
  - Use 3 dots icon on top right header of the page to add Exams,
